...
Spectator.describe StumpyBMP::FileData do
  let(file_data) { StumpyBMP::FileData.new(file_name: "spec/stumpy_bmp/examples/example2/image.bmp") }
  ...
  describe "#initialize" do
    ...
    context "when file_name param specified" do
      it "does not raise" do
        expect { StumpyBMP::FileData.new(file_name: "spec/stumpy_bmp/examples/example2/image.bmp") }.not_to raise_error
      end

      it "is NOT valid" do
        file_data = StumpyBMP::FileData.new(file_name: "spec/stumpy_bmp/examples/example2/image.bmp")
        expect(file_data.valid?).to be_false
      end
